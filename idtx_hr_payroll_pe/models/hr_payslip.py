...
class HrPayslip(models.Model):
    ...
    def _pe_compute_attendance_data(self):
        ...
        self.ensure_one()
        # MODO TAREO: no se leen las marcaciones. Los días/horas vienen del
        # Excel de tareo (worked_days + inputs); el motor devuelve ceros para
        # que manden esos valores. Ver res.company.l10n_pe_use_tareo.
    ...
    def _get_worked_day_lines(self, domain=None, check_out_of_version=True):
        """En modo tareo las líneas de días trabajados se generan desde el
        tareo (sobrevive a recomputaciones); si no, comportamiento estándar."""
        self.ensure_one()
