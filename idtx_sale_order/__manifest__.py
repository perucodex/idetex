...
Gestiona la carga de precios y productos en tus cotizaciones
    ...
    'data': [
        ...
        'report/report_printing_design_quote.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            'idtx_sale_order/static/src/portal/signature_form_patch.js',
            'idtx_sale_order/static/src/portal/name_and_signature_patch.xml',
        ],
        'web.assets_backend': [
            'idtx_sale_order/static/src/price_items/**/*',
            'idtx_sale_order/static/src/process_price_dates/**/*',
