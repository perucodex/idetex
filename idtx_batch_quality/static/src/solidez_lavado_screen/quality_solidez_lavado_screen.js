...
const DRAFT_STORAGE_KEY = "idtx_batch_quality.solidez_lavado_screen.draft.v1";
...
export class QualitySolidezLavadoScreen extends Component {
    ...
    async loadPartidas(query = "") {
        ...
        this.state.error = "";
        try {
            this.state.partidas = await this.orm.call("control.solidez.lavado.eval", "action_tablet_get_partidas", [query, 100]);
            this._syncSelectedPartidaData();
        } catch (error) {
    ...
    async finalizeEvaluation() {
        ...
        this.state.error = "";
        try {
            const result = await this.orm.call("control.solidez.lavado.eval", "action_tablet_finalize", [
...
QualitySolidezLavadoScreen.template = "idtx_batch_quality.QualitySolidezLavadoScreen";
registry.category("actions").add("idtx_quality.solidez_lavado_screen", QualitySolidezLavadoScreen);
