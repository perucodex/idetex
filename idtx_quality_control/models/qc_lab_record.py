...
class ControlLaboratorioRecord(models.Model):
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get("eval_number"):
                continue
            vals["eval_number"] = seq_model.next_by_code("qc.lab.record.eval_number") or "LABE00001"
    ...
    def _dimrev_first_eval_for_std(self):
        ...
        return first_record.est_revirado_eval_id if first_record else self.env["qc.dimstab.eval"]
    ...
    def _dimrev_report_payload(self):
        ...
        analysis = eval_rec.batch_id.qc_product_id.analysis_id
    ...
    def action_print_report(self):
        ...
        report_map = {
            "solidez_lavado": "idtx_quality_control.action_report_solidez_lavado",
            "dimrev": "idtx_quality_control.action_report_dimrev",
        }
...
class ControlLaboratorioRecordResult(models.Model):
    _name = "qc.lab.record.result"
    _description = "Resultado de Registro de Laboratorio"
    _order = "sequence asc, id asc"

    record_id = fields.Many2one("qc.lab.record", string="Registro", required=True, ondelete="cascade", index=True)
