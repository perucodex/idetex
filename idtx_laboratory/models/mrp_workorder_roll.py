...
class MrpWorkorderRoll(models.Model):
    ...
    # size_chart_domain = fields.Char('technical.size.line', compute='_compute_size_chart_m2m', store=False)
    ...
    # def _compute_size_chart_m2m(self):
    #     for rec in self:
    #         size_chart = rec.workorder_id.product_id.product_tmpl_id.technical_sheet_id
    #         if size_chart:
    #             rec.size_chart_domain = str([('technical_id', '=', size_chart)])
    #         else:
    #             rec.size_chart_domain = str([])
